...
if (is_array(@$engines)) {
    foreach ($engines as $engine) {
        ...
        if ($name . ".php" == $engine["page"]) {
            ...
            if ($id) {
                $array = array("id" => $id);
                $exTitle = (strpos($name, "news") !== false ? $core->getevents($array)[0]["name" . $clang] : (strpos($name, "projects") !== false && $core->getservices($array)[0]["name" . $clang] ? $core->getservices($array)[0]["name" . $clang] : (strpos($name, "products") !== false || $pagg == 3 ? $core->getproducts($array)[0]["name" . $clang] : $core->getprojects($array)[0]["name" . $clang])));
...
<head>
    ...
    <style type="text/css">
        ...
        <?php if ($plang) {  ?>.widget2 ul li a::before {
            content: "\f104";
            right: -1px;
            left: auto;
        }

        <?php   }  ?>.widget2 ul li a:after {
            opacity: 0;
        ...
        <?php if ($plang) { ?>.breadcrumb-item+.breadcrumb-item:before {
            float: right;
            padding-left: 0.5rem;
            padding-right: 0;
        }
        ...
        .breadcrumb-sec {
            ...
            background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('images/slide00.jpg');
    ...
    <?php if ($lang == "arabic" && 1 == 1) { ?>
        <style type="text/css">
            ...
            .main-header .outer-box .menu-area {
                ...
                position: relative;
                padding-right: 0;
                background: linear-gradient(to left, #1e7c81, #065f63);
                padding-left: 150px;
            }
...
<body>
    <div class="boxed_wrapper">
            ...
            <div class="popup-inner">
                <div class="upper-box clearfix">
                    <figure class="logo-box">
                        <a href="<?= $core->getPageUrl("index" . $plang) ?>"><img src="images/wlogo.png" alt="" /></a>
                    </figure>
                    <div class="close-search"><span class="far fa-times"></span></div>
                </div>
                <div class="overlay-layer"></div>
                <div class="auto-container">
                    <div class="search-form">
                        <form method="post" action="<?= $core->getPageUrl("products" . $plang) ?>">
                            <div class="form-group">
                                <fieldset>
                                    <input type="search" class="form-control" name="name" value="" placeholder="<?= plang("عما تبحث", "What are you looking for") ?>" required />
                    ...
                    <div class="upper-inner">
                        ...
                        <ul class="info-list clearfix">
                            <li>
                                ...
                                <h5><?= plang('إرسال بريد إلكتروني', 'Make An Email') ?></h5>
                                <p><a href="mailto:<?= getValue('email') ?>"><?= getValue('email') ?></a></p>
                            </li>

                            <li>
                                <div class="icon-box"><i class="fal fa-map-marker-check"></i></div>
                                <h5><?= plang('Find Us', 'اعثر علينا', 1) ?></h5>
                                <p><a href="<?= getValue('direct_map') ?>"><?= plang('Get Our Location', 'الحصول على موقعنا', 1) ?></a></p>
                            </li>
                        </ul>
                        ...
                        <div class="social-info-wrapper">
                            <ul class="social-info">
                                <li class="social-facebook">
                                    <a class="social-icon" target="_blank" href="<?= getValue('facebook') ?>" rel="nofollow"><i class="fab fa-facebook-f"></i></a>
                                </li>
                                <li class="social-facebook">
                                    <a class="social-icon" target="_blank" href="<?= getValue('twitter') ?>" rel="nofollow"><i class="fab fa-twitter"></i></a>
                                </li>
                                <li class="social-facebook">
                                    <a class="social-icon" target="_blank" href="<?= getValue('instagram') ?>" rel="nofollow"><i class="fab fa-instagram"></i></a>
                                </li>
                                <li class="social-facebook">
                                    <a class="social-icon" target="_blank" href="<?= getValue('linkedin') ?>" rel="nofollow"><i class="fab fa-linkedin-in"></i></a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="lang-box">
                            <div class="bo">
                                <a href="<?= plang($core->getPageUrl("index"), $core->getPageUrl("indexarabic")) ?>" title=""> <i class="icon-47"></i> <?= plang('English', 'Arabic') ?></a>
                            </div>
                        </div>
                            ...
                            <nav class="main-menu navbar-expand-md navbar-light">
                                <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                    <ul class="navigation clearfix">
                                        <li class="current"><a href="<?= $core->getPageUrl("index" . $plang) ?>" title=""><?= getTitle("index" . $plang) ?></a></li>
                                        ...
                                        <li><a href="<?= $core->getPageUrl("partners" . $plang) ?>" title=""><?= getTitle("partners" . $plang) ?></a></li>
                        ...
                        <div class="nav-right">
                            <div class="btn-box">
                                <a href="" class="theme-btn btn-one">
                                    <div class="iton">
                                        <div class="icon-box"><i class="icon-48"></i></div>
                                        <h5><?= plang("Need Help Now?", "بحاجة الى مساعدة الآن؟", 1) ?></h5>
                                        <p><?= getValue("mobile") ?></p>
                                    </div>
                                </a>
                            </div>
        ...
        <div class="mobile-menu">
            ...
            <nav class="menu-box">
                <div class="nav-logo">
                    <a href="<?= $core->getPageUrl("index" . $plang) ?>"><img src="images/wlogo.png" alt="" title="" /></a>
                </div>
                ...
                <div class="social-links">
                    <ul class="clearfix">
                        <li>
                            <a href="<?= getValue('twitter') ?>"><span class="fab fa-twitter"></span></a>
                        </li>
                        <li>
                            <a href="<?= getValue('facebook') ?>"><span class="fab fa-facebook-f"></span></a>
                        </li>
                        <li>
                            <a href="<?= getValue('instagram') ?>"><span class="fab fa-instagram"></span></a>
                        </li>
                        <li>
                            <a href="<?= getValue('youtube') ?>"><span class="fab fa-youtube"></span></a>
                        </li>
                    </ul>
                </div>
            </nav>
        ...
        <?php if ($pagg != 1) {
            ...
            <section>
                <div class="breadcrumb-sec w-100 pt-170 pb-150 dark-layer3 opc7 position-relative">
                    <div class="fixed-bg" style="background-image: url(images/slide00.jpg);"></div>
                    <div class="container">
                        <div class="page-top-wrap w-100">
                            <h1 class="mb-0"><?= $pageTitle ?></h1>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index<?= $plang ?>.php" title=""><?= getTitle("index" . $plang) ?></a></li>
                                <?php if (isv("level") || isv("id")) {  ?>
                                    <li class="breadcrumb-item"><a href="<?= $name ?>.php" title=""><?= getTitle($name) ?></a></li>
